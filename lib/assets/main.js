...
const { getAccount, getChainId, getChains, getToken, signMessage, getBalance, readContract,readContracts, writeContract, getBlockNumber, getGasPrice, getTransactionCount, estimateGas, getTransactionReceipt } = WagmiCore
...
class JSWagmiCore {
  ...
  getTransactionReceipt = async function (getTransactionReceiptParameters) {
    try {
      var transactionReceipt = await getTransactionReceipt(config(), getTransactionReceiptParameters);
      console.log("transactionReceipt res", transactionReceipt);
