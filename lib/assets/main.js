...
const { getAccount, getChainId, getChains, getToken, signMessage, getBalance, readContract, readContracts, writeContract, getBlockNumber, getGasPrice, getTransactionCount, estimateGas, getTransactionReceipt, sendTransaction, watchChainId, getTransaction } = WagmiCore
...
class JSWagmiCore {
  ...
  getTransaction = async function (getTransactionParameters) {
    try {
      var transaction = await getTransaction(config(), getTransactionParameters);
